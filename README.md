...
Still in the created **proxy** folder, I created the configuration file``nano proxy/httpd.conf`` with the content from ![that link](assets/httpd.conf) (Apache2 Conf File).
